...
class StaffQuestionsViewController: JSQMessagesViewController {
    
    var user: FAuthData?
    // var message = JSQMessage(
    var messages = [JSQMessage]()
    var avatars = Dictionary<String, UIImage>()
    var outgoingBubbleImageView = JSQMessagesBubbleImageFactory().outgoingMessagesBubbleImageWithColor(UIColor.grayColor())
    var incomingBubbleImageView = JSQMessagesBubbleImageFactory().incomingMessagesBubbleImageWithColor(UIColor.greenColor())
    // var incomingBubbleImageView = JSQMessagesBubbleImageFactory().incomingMessageBubbleImageViewWithColor(UIColor.greenColor())
    var senderImageUrl: String! = "https://pbs.twimg.com/profile_images/555505646804553728/_BiDXH55_normal.jpeg"
    ...
    func setupFirebase() {
        ...
        messagesRef = Firebase(url: "https://chattestttttsd.firebaseio.com/messages")
        ...
        messagesRef.queryLimitedToNumberOfChildren(25).observeEventType(FEventType.ChildAdded, withBlock: { (snapshot) in
            ...
            print("EEEEE\(imageUrl)")
            // let message = Message(text: text, sender: sender, imageUrl: imageUrl)
            let message = JSQMessage(senderId: "123", displayName: "jsus", text: text)
    ...
    func tempSendMessage(text: String!, sender: String!) {
        // let message = JSQMessage(text: text, sender: sender, imageUrl: senderImageUrl)
        let message = JSQMessage(senderId: "123", displayName: "jsus", text: text)
    ...
    override func viewDidLoad() {
        ...
        let profileImageUrl = senderImageUrl
